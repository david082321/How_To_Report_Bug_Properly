...
## 「出了問題之後，我做了……」
當一個錯誤或bug發生的時候，您可能會做許多事情。但是大多數人會使事情變的更糟。我的一個朋友在學校裡誤刪了她所有的Word文件，在找人幫忙之前她重裝了Word，又運行了一遍硬碟整理程式，這些操作對於恢復文件是毫無益處的，因為這些操作搞亂了硬碟的文件區塊。恐怕在這個世界上沒有一種復原軟體能恢復她的文件了。如果她不做任何操作，或許還有一線希望。
